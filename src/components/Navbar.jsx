          ...
          <div className="relative h-full px-12 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-16">
              {leftNavItems.map((item) => (
                ...
                >
                  <span className={`text-sm tracking-[0.3em] font-medium transition-all duration-300 ${
                    scrolled 
            ...
            >
              <div className="relative">
                ...
                <div className={`relative w-24 h-24 rounded-2xl rotate-45 shadow-2xl transition-all duration-300 group-hover:scale-105 ${
                  scrolled 
        ...
        <div className="h-full px-5 flex items-center justify-between">
          ...
          >
            <div className="relative w-5 h-4">
              <div className={`absolute left-0 w-full h-0.5 rounded-full transition-all duration-300 ${
                isMenuOpen 
