...
const Hero = () => {
    ...
    // Your original stats from StatsSection.jsx - EXACT
    const resortStats = [
        {
            icon: FaMountain,
            prefix: "over",
        ...
        <div className=" pl-0 sm:pl-6 lg:pl-12 pt-8 sm:pt-12">
            ...
            <div className="relative overflow-hidden h-auto lg:h-[740px]">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 h-full">
                    ...
                    <div className="relative p-8 md:p-12 lg:p-16 flex flex-col justify-center min-h-screen">                        <div className="max-w-3xl">


                        {/* Animated Heading - YOUR EXACT TEXT */}
                        <div ref={headingRef} className="opacity-0 translate-y-8 transition-all duration-700 ease-out py-6">
                            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 leading-tight mb-4">
                                Unwind and Rejuvenate <br />
                                <span className="text-emerald-700">in Nature's Embrace</span>
                            </h1>

                        </div>

                        {/* Stats Section - ONLY fixed the grid layout */}
                        <div ref={statsRef} className="opacity-0 translate-y-8 transition-all duration-700 ease-out ">
                        ...
                        {/* CTA Button - YOUR EXACT */}
                        <div ref={buttonRef} className="opacity-0 translate-y-8 transition-all duration-700 ease-out py-12">
                    ...
                    {/* Right Side - Image with Floating Elements - YOUR EXACT */}
                    <div className="relative h-[600px] lg:h-full">
                        {/* Background Image Container with Circular Mask */}
                        <div className="absolute inset-0 overflow-hidden">
                            <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/20 to-emerald-700/10"></div>
                            ...
                            {/* Floating Circular Elements - YOUR EXACT */}
            ...
            {/* Add floating animations to CSS - YOUR EXACT */}
            <style jsx>{`
