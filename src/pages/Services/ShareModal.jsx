    ...
    <div className="bg-white rounded-2xl max-w-sm w-full p-6">
      <div className="flex justify-between items-center mb-6">
        <h3 className="text-xl font-semibold text-gray-900">
          <RiIcons.RiShareForwardLine className="inline mr-2" />
          Share this Service
        </h3>
        <button
          onClick={onClose}
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-4 gap-4">
          ...
          >
            <FaIcons.FaFacebook className="text-2xl mb-2" />
          ...
          >
            <FaIcons.FaTwitter className="text-2xl mb-2" />
          ...
          >
            <FaIcons.FaWhatsapp className="text-2xl mb-2" />
          ...
          >
            <FaIcons.FaLink className="text-2xl mb-2" />
