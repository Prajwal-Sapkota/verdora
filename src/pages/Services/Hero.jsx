        ...
        <div className="pt-18 sm:pt-0">
            ...
            <div className="relative rounded-b-2xl overflow-hidden h-[500px] md:h-[550px] lg:h-[740px]">
                ...
                <div className="absolute inset-0">
                    <img 
                        src="/images/services.jpg" // Services page image
                        alt="Our Luxury Services" 
                        ...
                        <div className="max-w-3xl">
                            ...
                            <div ref={textRef} className="opacity-0 translate-y-8 transition-all duration-700 ease-out mb-10">
                                <p className="text-lg md:text-xl text-gray-200 leading-relaxed max-w-2xl">
                                    Experience unparalleled luxury and personalized care at Verdora Resort. 
                                    From rejuvenating spa treatments to gourmet dining and bespoke experiences, 
                                    we craft moments that linger in memory long after your stay.
                                </p>
                            </div>
